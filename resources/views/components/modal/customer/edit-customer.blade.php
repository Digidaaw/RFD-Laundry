{{--
    ...
    - Menggunakan 'openEditModal' dan 'editData' dari x-data parent (<main>).
    - Jika validasi update gagal, parent sudah set openEditModal=true dan editData dari old().
    - Hidden input 'edit_url' memastikan URL action tersimpan di old() saat redirect back.
--}}
<div
