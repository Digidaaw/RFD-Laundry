    ...
    <div @click.away="openEditModal = false" x-transition:enter="transition ease-out duration-300 transform"
        ...
        <form x-bind:action="editData.url" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="username" placeholder="Masukkan username" x-model="editData.username"
                    class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" />
            </div>
            ...
            <div class="mb-4" x-data="{ showPassword: false }">
                ...
                <div class="relative">
                    <input :type="showPassword ? 'text' : 'password'" id="password_edit" name="password"
