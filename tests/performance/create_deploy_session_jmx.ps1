$jmxPath = "C:\Users\ashar\Documents\1. Kuliah\RFD Laundry Management System\RFD-Laundry\tests\performance\RFD_Transaksi_Deploy_Session_Test.jmx"

# URL-decode laravel_session (%3D -> =)
...
<jmeterTestPlan version="1.2" properties="5.0" jmeter="5.6.3">
  <hashTree>
    <TestPlan guiclass="TestPlanGui" testclass="TestPlan"
              testname="RFD Laundry - Transaksi DEPLOY Test (Pre-Auth Session)"
              enabled="true">
      <stringProp name="TestPlan.comments">
====================================================================
FITUR      : MENGELOLA DATA TRANSAKSI
TESTER     : FAI
TEST CASE  : TC-TRX-02 (DEPLOY) - 10 user, ramp-up 60 detik

METODE     : Pre-Authenticated Session
             Login dilakukan manual via browser, laravel_session
             diambil dari cookies browser dan diset ke JMeter.
             JMeter langsung mengakses /transaksi tanpa melalui
             proses login (bypass Cloudflare Bot Protection).

ENDPOINT   :
  - GET /transaksi        Tampil daftar transaksi
  - GET /transaksi?search Pencarian transaksi

CATATAN    : laravel_session perlu diperbarui jika expired (+- 2 jam)
             F12 > Application > Cookies > salin laravel_session
====================================================================
      </stringProp>
    ...
    <hashTree>
      ...
      <!-- Header Manager: User-Agent seperti browser nyata -->
      <HeaderManager guiclass="HeaderPanel" testclass="HeaderManager"
        ...
        <collectionProp name="HeaderManager.headers">
          ...
          <elementProp name="" elementType="Header">
            ...
            <stringProp name="Header.value">id-ID,id;q=0.9,en-US;q=0.8</stringProp>
          </elementProp>
        </collectionProp>
      </HeaderManager>
      <hashTree/>
      ...
      <!-- ================================================================ -->
      <!--  TC-TRX-02 - DEPLOY (10 user, Ramp-up 60s)                       -->
      <!--  URL  : https://laundry.aksaralearning.com                       -->
      <!--  Auth : Pre-Auth via laravel_session cookie (skip login)         -->
      <!-- ================================================================ -->
      <ThreadGroup guiclass="ThreadGroupGui" testclass="ThreadGroup"
                   testname="TC-TRX-02 - DEPLOY (10 User, Ramp-up 60s) - Pre-Auth"
                   enabled="true">
      ...
      <hashTree>
        ...
        <!-- Cookie Manager dengan laravel_session pre-set (hasil login manual) -->
        <CookieManager guiclass="CookiePanel" testclass="CookieManager"
                       testname="[TC-TRX-02] Cookie Manager - Pre-Auth Session"
                       enabled="true">
          <collectionProp name="CookieManager.cookies">
            ...
            <elementProp name="wssplashchk" elementType="Cookie" testname="wssplashchk">
              <stringProp name="Cookie.value">3529613bcfa9c87f06e0889d2f37efc03b7c48aa.1781257098.1</stringProp>
              <stringProp name="Cookie.domain">laundry.aksaralearning.com</stringProp>
              <stringProp name="Cookie.path">/</stringProp>
              <boolProp name="Cookie.secure">true</boolProp>
              <longProp name="Cookie.expires">0</longProp>
        ...
        <!-- HTTP Defaults DEPLOY -->
        <ConfigTestElement guiclass="HttpDefaultsGui" testclass="ConfigTestElement"
                           testname="[TC-TRX-02] HTTP Defaults DEPLOY" enabled="true">
        ...
        <!-- Step 1: GET /transaksi -->
        <HTTPSamplerProxy guiclass="HttpTestSampleGui" testclass="HTTPSamplerProxy"
                          testname="[TC-TRX-02] Step 1: GET /transaksi - Daftar Transaksi"
                          enabled="true">
        ...
        <hashTree>
          <ResponseAssertion guiclass="AssertionGui" testclass="ResponseAssertion"
                             testname="Assert: HTTP 200 (bukan redirect ke login)" enabled="true">
            <collectionProp name="Asserion.test_strings">
              <stringProp name="49586">200</stringProp>
            </collectionProp>
            <stringProp name="Assertion.custom_message">[TC-TRX-02] GET /transaksi gagal - session expired? Perbarui laravel_session</stringProp>
          ...
          <ConstantTimer guiclass="ConstantTimerGui" testclass="ConstantTimer"
                         testname="Think Time 1000ms" enabled="true">
            <stringProp name="ConstantTimer.delay">1000</stringProp>
          </ConstantTimer>
          <hashTree/>
        </hashTree>

        <!-- Step 2: GET /transaksi?search -->
        <HTTPSamplerProxy guiclass="HttpTestSampleGui" testclass="HTTPSamplerProxy"
                          testname="[TC-TRX-02] Step 2: GET /transaksi?search - Pencarian"
                          enabled="true">
          <stringProp name="HTTPSampler.path">/transaksi</stringProp>
          <stringProp name="HTTPSampler.method">GET</stringProp>
          <boolProp name="HTTPSampler.follow_redirects">true</boolProp>
        ...
        <hashTree>
          <ResponseAssertion guiclass="AssertionGui" testclass="ResponseAssertion"
            ...
            <stringProp name="Assertion.custom_message">[TC-TRX-02] GET /transaksi?search gagal</stringProp>
            <stringProp name="Assertion.test_field">Assertion.response_code</stringProp>
            <boolProp name="Assertion.assume_success">false</boolProp>
            <intProp name="Assertion.test_type">8</intProp>
          </ResponseAssertion>
        ...
        <ResultCollector guiclass="SummaryReport" testclass="ResultCollector"
                         testname="[TC-TRX-02] Summary Report" enabled="true">
          ...
          <stringProp name="filename">tests/performance/results/Transaksi/TC-TRX-02_DEPLOY_summary.csv</stringProp>
        </ResultCollector>
        <hashTree/>

        <ResultCollector guiclass="StatVisualizer" testclass="ResultCollector"
                         testname="[TC-TRX-02] Aggregate Report" enabled="true">
          <boolProp name="ResultCollector.error_logging">false</boolProp>
          <objProp>
            <name>saveConfig</name>
            <value class="SampleSaveConfiguration">
          ...
          <stringProp name="filename">tests/performance/results/Transaksi/TC-TRX-02_DEPLOY_aggregate.csv</stringProp>
        </ResultCollector>
        <hashTree/>

        <ResultCollector guiclass="ViewResultsFullVisualizer" testclass="ResultCollector"
                         testname="[TC-TRX-02] View Results Tree" enabled="true">
          <boolProp name="ResultCollector.error_logging">false</boolProp>
          <objProp>
            <name>saveConfig</name>
            <value class="SampleSaveConfiguration">
...
[System.IO.File]::WriteAllText($jmxPath, $jmx, [System.Text.Encoding]::UTF8)

# Verifikasi
$v = [System.IO.File]::ReadAllText($jmxPath, [System.Text.Encoding]::UTF8)
Write-Host "=== VERIFIKASI FILE BARU ==="
Write-Host "File size         : $($v.Length) bytes"
Write-Host "laravel_session   : $($v.Contains('laravel_session'))"
Write-Host "wssplashchk       : $($v.Contains('wssplashchk'))"
Write-Host "GET /transaksi    : $($v.Contains('/transaksi'))"
Write-Host "HtmlExtractor     : $($v.Contains('HtmlExtractor'))"
Write-Host ""
Write-Host "File dibuat: $jmxPath"
